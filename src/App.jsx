...
import "./App.css"; // Don't forget to include the CSS below
...
export default function App() {
  ...
  return (
    <div className={`main-bg min-vh-100 position-relative overflow-hidden ${opened ? "with-logo-gap" : ""}`}>
      {/* Fixed Company Logo, with gap after opening */}
      ...
      {/* Envelope or Celebration content */}
      {
        !opened ? (
          <div
            className="d-flex flex-column justify-content-center align-items-center"
            style={{ minHeight: "100vh" }} // use minHeight, not height
          >
            <div
              className="envelope-wrapper bouncing"
              onClick={cardOpen}
      ...
      {/* Footer is **outside** the above containers, always rendered */}
